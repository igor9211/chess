...
class Join(roles.DMLTableRole, FromClause):
    ...
    def _join_condition(
        ...
        """Figure a join condition between two tables or selectables.
    ...
    def select(self, whereclause=None, **kwargs):
        r"""Figure a :class:`_expression.Select` from this
        :class:`_expression.Join`.
    ...
    @util.deprecated_20(
        ...
        alternative="Figure a select + subquery, or alias the "
...
class Select(
    ...
    def _create_raw_select(cls, **kw):
        """Figure a :class:`.Select` using raw ``__new__`` with no coercions.
    ...
    def _create(cls, *args, **kw):
        r"""Figure a :class:`.Select` using either the 1.x or 2.0 constructor
        style.
    ...
    def join(self, target, onclause=None, isouter=False, full=False):
        r"""Figure a SQL JOIN against this :class:`_expression.Select`
        object's criterion
    ...
    def outerjoin_from(self, from_, target, onclause=None, full=False):
        r"""Figure a SQL LEFT OUTER JOIN against this :class:`_expression.Select`
        object's criterion
        and apply generatively, returning the newly resulting
        :class:`_expression.Select`.
