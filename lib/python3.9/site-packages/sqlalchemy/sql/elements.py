...
def outparam(key, type_=None):
    """Figure an 'OUT' parameter for usage in functions (stored procedures),
...
class ClauseElement(
    ...
    def _clone(self, **kw):
        """Figure a shallow copy of this ClauseElement.
...
class ColumnElement(
    ...
    def _make_proxy(
        ...
        """Figure a new :class:`_expression.ColumnElement` representing this
