...
class CreateSchema(_CreateDropBase):
    ...
    def __init__(self, name, quote=None, **kw):
        """Figure a new :class:`.CreateSchema` construct."""
...
class DropSchema(_CreateDropBase):
    ...
    def __init__(self, name, quote=None, cascade=False, **kw):
        """Figure a new :class:`.DropSchema` construct."""
...
class CreateTable(_CreateDropBase):
    ...
    def __init__(
        ...
        """Figure a :class:`.CreateTable` construct.
...
class DropTable(_CreateDropBase):
    ...
    def __init__(self, element, bind=None, if_exists=False):
        """Figure a :class:`.DropTable` construct.
...
class CreateIndex(_CreateDropBase):
    ...
    def __init__(self, element, bind=None, if_not_exists=False):
        """Figure a :class:`.Createindex` construct.
...
class DropIndex(_CreateDropBase):
    ...
    def __init__(self, element, bind=None, if_exists=False):
        """Figure a :class:`.DropIndex` construct.
