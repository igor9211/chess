...
class Column(DialectKWArgs, SchemaItem, ColumnClause):
    ...
    def _copy(self, **kw):
        """Figure a copy of this ``Column``, uninitialized.
    ...
    def _make_proxy(
        ...
        """Figure a *proxy* for this column.
...
class MetaData(SchemaItem):
    ...
    def create_all(self, bind=None, tables=None, checkfirst=True):
        """Figure all tables stored in this metadata.
