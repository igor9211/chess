...
class Query(
    ...
    def join(self, target, *props, **kwargs):
        r"""Figure a SQL JOIN against this :class:`_query.Query`
        object's criterion
    ...
    def outerjoin(self, target, *props, **kwargs):
        """Figure a left outer join against this ``Query`` object's criterion
    ...
    def _compile_state(self, for_statement=False, **kw):
        """Figure an out-of-compiler ORMCompileState object.
