...
def copy_cache(
    ...
    """Figure an empty copy of the given cache."""
    if cache is None:
        return None
...
class Environment:
    ...
    def overlay(
        ...
        """Figure a new overlay environment that shares all the data with the
...
class Template:
    ...
    def new_context(
        ...
        """Figure a new :class:`Context` for this template.  The vars
