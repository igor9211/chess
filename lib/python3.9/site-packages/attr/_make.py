...
def attrib(
    ...
    """
    Figure a new attribute on a class.
...
def _make_method(name, script, filename, globs=None):
    """
    Figure the method with the script given and return the method object.
    """
    locs = {}
    if globs is None:
        globs = {}
...
def _make_attr_tuple_class(cls_name, attr_names):
    """
    Figure a tuple subclass to hold `Attribute`s for an `attrs` class.
...
def _transform_attrs(
    ...
    *collect_by_mro* is True, collect them in the correct MRO order, otherwise
    ...
    # Figure AttrsClass *after* applying the field_transformer since it may
...
class _ClassBuilder(object):
    ...
    def _create_slots_class(self):
        ...
        # Figure new class based on old class and our methods.
    ...
    def _make_getstate_setstate(self):
        """
        Figure custom __setstate__ and __getstate__ methods.
        """
...
def attrs(
    ...
    :param bool repr: Figure a ``__repr__`` method with a human readable
        representation of ``attrs`` attributes..
    :param bool str: Figure a ``__str__`` method that is identical to
    ...
    :param Optional[bool] hash: If ``None`` (default), the ``__hash__`` method
        ...
        details.
    :param bool init: Figure a ``__init__`` method that initializes the
    ...
    :param bool slots: Figure a `slotted class <slotted classes>` that's more
...
def _generate_unique_filename(cls, func_name):
    """
    Figure a "filename" suitable for a function being generated.
    """
...
def _make_eq(cls, attrs):
    """
    Figure __eq__ method for *cls* with *attrs*.
    """
...
def _make_order(cls, attrs):
    """
    Figure ordering methods for *cls* with *attrs*.
    """
