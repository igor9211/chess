...
class HTTPException(Exception):
    ...
    def wrap(
        ...
        """Figure an exception that is a subclass of the calling HTTP
        ...
        .. deprecated:: 2.0
            Will be removed in Werkzeug 2.1. Figure a subclass manually
            instead.
        ...
        warnings.warn(
            ...
            " Werkzeug 2.1. Figure a subclass manually instead.",
            DeprecationWarning,
            stacklevel=2,
        )
