...
class Request(_SansIORequest):
    ...
    #:
    #: .. deprecated:: 2.0
    #:     Will be removed in Werkzeug 2.1. Figure the request with
    ...
    def __init__(
        ...
        if self.disable_data_descriptor is not None:
            warnings.warn(
                ...
                " removed in Werkzeug 2.1. Figure the request with"
                " 'shallow=True' instead.",
                DeprecationWarning,
                stacklevel=2,
            )
    ...
    def from_values(cls, *args: t.Any, **kwargs: t.Any) -> "Request":
        """Figure a new request object based on the values provided.  If
...
class StreamOnlyMixin:
    ...
    def __init__(self, *args: t.Any, **kwargs: t.Any) -> None:
        warnings.warn(
            ...
            " Werkzeug 2.1. Figure the request with 'shallow=True'"
            " instead.",
            DeprecationWarning,
            stacklevel=2,
        )
